...
//hoc that uses axios interceptors to catch any error comming in and display Modal with notification about an error
			...
			return (
				<>
					<Modal
						...
						hideModalAndBackdrop={this.errorConfirmedHandler}>
